...
print(matriz_riesgo)
precision_riesgo = precision_score(y_test_riesgo, y_pred_riesgo, average = "binary", pos_label = "menor")
...
sensibilidad_riesgo = recall_score(y_test_riesgo, y_pred_riesgo, average = "binary", pos_label = "menor") 
...
precision_monto_financiado = precision_score(y_test_monto_financiado, y_pred_monto_financiado, average = "binary", pos_label = "menor")
...
sensibilidad_monto_financiado = recall_score(y_test_monto_financiado, y_pred_monto_financiado, average = "binary", pos_label = "menor") 
print("Sensibilidad:", sensibilidad_monto_financiado)
puntajef1_monto_financiado = f1_score(y_test_monto_financiado, y_pred_monto_financiado, average = "binary", pos_label = "menor")
...
precision_costo_total = precision_score(y_test_costo_total, y_pred_costo_total, average = "binary", pos_label = "menor")
...
sensibilidad_costo_total = recall_score(y_test_costo_total, y_pred_costo_total, average = "binary", pos_label = "menor") 
print("Sensibilidad:", sensibilidad_costo_total)
puntajef1_costo_total = f1_score(y_test_costo_total, y_pred_costo_total, average = "binary", pos_label = "menor")
